defmodule MyPortal do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :simple_one_for_one, name: MyPortal.Supervisor]
  ...
  defimpl Inspect, for: MyPortal do
    def inspect(%MyPortal{left: left, right: right}, _) do
  ...
  """
  def shoot(color) do
    Supervisor.start_child(MyPortal.Supervisor, [color])
  end
